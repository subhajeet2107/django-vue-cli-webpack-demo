    ...
    'JAVASCRIPT':{
        'global_js':{
                'source_filenames': (
                    ...
                    'vendor/js/firebase-app.js',
                    'vendor/js/firebase-messaging.js',
                    'vendor/js/jquery.form-validator.min.js',
                    'vendor/js/jquery.uploadfile.js',
                    'vendor/js/owl.carousel.min.js',
                    'vendor/js/slick.min.js'
                ),
                'output_filename': 'css/global.min.js',
        },
        'custom_js':{
                'source_filenames': (
                    'js/main.js',
                ),
                'output_filename': 'css/home.min.js',
        }
    }
}
